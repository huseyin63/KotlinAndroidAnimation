...
class MainActivity : AppCompatActivity() {
    ...
    // Bu fonksiyon animasyonda bir animasyon çalıştırdıgımızda o bitmeden aynı animasyonu tekrardan çalıştırmamızı engeller ve animasyonun düzgün çalışmasını sağlar
